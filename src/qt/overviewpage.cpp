...
void OverviewPage::displayAssetInfo()
{
    ...
    if (thresholdState == THRESHOLD_STARTED) {
        ...
        currentPercentage.sprintf("");
        ui->assetInfoPercentageValue->setText(currentPercentage);

        QString possible = statsStruct.possible ? tr("") : tr("");
        ui->assetInfoPossibleValue->setText(possible);

        ui->assetInfoBlocksLeftValue->setText("");
        ...
        ui->assetInfoBlockLabel->setText(tr("") + "");
        ui->assetInfoBlockValue->setText("");
